...
export function ViewPanel({ sort, columns, view, onSort, onView, mapPage = false }: {
  ...
  return <div className="view-panel">
    {!mapPage && <><section><h3>照片视图</h3><ViewModeSegment view={view} onChange={value => onView(value)} /></section><LinearDivider /></>}

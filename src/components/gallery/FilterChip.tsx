...
export const filterLabels: Record<keyof Filters, string> = { query: '搜索', project: '项目', camera: '相机', lens: '镜头', tag: '标签', start: '开始日期', end: '结束日期' };
export const filterIcons: Record<keyof Filters, string> = { query: 'search', project: 'list-ordered', camera: 'camera', lens: 'aperture', tag: 'tag', start: 'calendar', end: 'calendar' };

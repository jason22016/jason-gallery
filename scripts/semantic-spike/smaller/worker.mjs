...
async function benchmark({candidate='trim64k',variant='int8wo',backend='webgpu',repeats=3,threads=4,limit=48,profile=false,simulateNoWebGPU=false}={}) {
 ...
 return {candidate,variant,backend,requestedBackend,fallbackReason,simulateNoWebGPU,repeats,threads:effectiveThreads,crossOriginIsolated:self.crossOriginIsolated,userAgent:navigator.userAgent,
